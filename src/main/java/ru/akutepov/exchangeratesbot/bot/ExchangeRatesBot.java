...
//
//    private static final String KATYSU = "/акпарат";
//    private static final String AKPARAT = "/акпарат";
//    private static final String TIRKELU = "/тиркелу";
//    private static final String KERI_BAILANYS = "/кери_байланыс";
//
//    @Autowired
...
//                Кош келдиниз, %s!
//
//                Сиз бул бот аркылы агымдагы конкурстар туралы акпарат ала аласыз немесе катысуга отиним калдыра аласыз.
//
//                Для этого воспользуйтесь командами:
//                /akparat
//                /katysu
//                /tirkelu
//                /kery_bailanys  - менеджер хабарласады
//                """;
