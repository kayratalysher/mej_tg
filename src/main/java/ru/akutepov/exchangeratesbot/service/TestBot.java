...
public class TestBot extends TelegramLongPollingBot {
    ...
    @Value("${bots.test.token:8392819757:AAHEqiK5rRJ45EyXGfm-fOc3CLs501cxlEY}")
...
//            }
    ...
    private void showContestDetails(Long chatId, Integer messageId, int contestId) {
        ...
        photo.setPhoto(new InputFile(contest.getImageUrl()));
        photo.setCaption(contest.getDescription());

        InlineKeyboardMarkup keyboard = new InlineKeyboardMarkup(List.of(
                List.of(button("✅ Қатысу", "participate_contest")),
                List.of(button("📄 Ереже", "download_contest_" + contestId)),
        ...
        try {
            ...
            log.error("Telegram send photo error", e);
            sendText(chatId, "Қате шықты. Кейін қайталап көріңіз.");
        }
    }
